...
console.log("t1--------1")
  ...
  console.log("EmpData--------123",EmpData)
...
let setFileNameSR= {"EmpId":EmpData.EmpId,"OfferTempleteId":EmpData.OfferTempleteId,"OfferLetterFileName":fileName,"UserName":EmpData.EmpName}
      ...
      await axios.post(baseUrl + MethodNames.UpsertMasterEmployeeOfferLetter, MasterEmployeeAUpdate).then(()=>{
        ...
        //     console.log("err--------1",err,PDFBASEPATH)
        //     if (err) {
